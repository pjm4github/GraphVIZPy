...
class EdgeSeqLink:  # This is a derived class to handle the MACRO EDGEOF in /core/core.h
    """
...
class Edge(Agobj):   # from core/core.c
    ...
    Attributes:
        ...
        node:  Typically, core stores 'edge.node' for whichever node is relevant
    ...
    def __init__(self, tail: 'Node', head: 'Node', name: str, graph: 'Graph', id_=None,
        ...
        # You might also store a single "node" pointer that core uses
    ...
    def etype(self, new_etype: str):
        ...
        #    core logic: out-edge => node=tail; in-edge => node=head
