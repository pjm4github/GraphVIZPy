...
class SaveET:  # from /core/cmpnd.c  (compound node functions)
    """
...
class SaveStackT:  # from /core/cmpnd.c  (compound node functions)
    """
...
class Agcmpedge:  # from /core/cmpnd.c  (compound node functions)
    """
...
class Agdesc:  # from /core/enclosed_node.c
    """
...
class Agclos:  # from /core/enclosed_node.c, /core/core.h
    """
...
class AgIdDisc:  # from /core/enclosed_node.c (from core.h)
    """
    ...
    """
    # object ID allocator discipline core.h line 179
    #
    # struct Agiddisc_s {
...
# class AgSym:  # from core/core.c
#     """
#     A Pythonic equivalent of 'Agsym_t' from core:
...
# class AgAttrRecord(dict):  # from core/core.c
#     """
#     A Pythonic equivalent of 'Agattr_t' from core:
...
def AGOPP(e: "Edge") -> "Edge":
    ...
    Equivalent to `AGOPP(e)` in core macros:
...
def AGMKOUT(e: "Edge") -> "Edge":
    ...
    Equivalent to `AGMKOUT(e)` in core:
...
def AGMKIN(e: "Edge") -> "Edge":
    ...
    Equivalent to `AGMKIN(e)` in core:
...
def AGTAIL(e: "Edge") -> "Node":
    ...
    Equivalent to `AGTAIL(e)` in core macros:
      - The tail node is stored in the 'in-edge' variant's e->node in core,
...
def AGHEAD(e: "Edge") -> "Node":
    ...
    Equivalent to `AGHEAD(e)` in core macros:
      - The head node is stored in the 'out-edge' variant's e->node in core,
...
def AGEQEDGE(e: "Edge", f: "Edge") -> bool:
    ...
    Equivalent to `AGEQEDGE(e, f)` in core:
      - Checks if AGMKOUT(e) == AGMKOUT(f)
    """
    return AGMKOUT(e) is AGMKOUT(f)

# For convenience, you can also define aliases matching the core names:
agopp   = AGOPP
agmkout = AGMKOUT
agmkin  = AGMKIN
agtail  = AGTAIL
