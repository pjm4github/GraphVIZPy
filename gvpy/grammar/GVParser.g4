// GVParser.g4 — ANTLR4 parser grammar for the Graphviz DOT language.
// Based on https://graphviz.org/doc/info/lang.html and the original
// Graphviz grammar.y.
//
// Renamed from DOTParser.g4 to GVParser.g4 as part of the GraphvizPy
// (gvpy) package restructuring.

parser grammar GVParser;

options { tokenVocab = GVLexer; }
