"""
DOTGraphVisitor — walks the ANTLR4 parse tree and constructs
pycode.cgraph.graph.Graph objects.
"""
...
from DOTParserVisitor import DOTParserVisitor           # noqa: E402

from pycode.cgraph.graph import Graph                    # noqa: E402
from pycode.cgraph.node import Node                      # noqa: E402
from pycode.cgraph.headers import Agdesc                   # noqa: E402


class DOTGraphVisitor(DOTParserVisitor):
    """Visits a DOT parse tree and produces a Graph object."""
    ...
    def _resolve_node_id(self, ctx: DOTParser.NodeIdContext) -> tuple[str, str]:
    ...
    def _get_id_text(self, ctx: DOTParser.Id_Context) -> str:
    ...
    def _get_html_text(self, ctx: DOTParser.HtmlStringContext) -> str:
    ...
    def _get_html_content_text(self, ctx: DOTParser.HtmlContentContext) -> str:
    ...
    def _get_attrs(self, ctx: DOTParser.AttrListContext) -> dict[str, str]:
    ...
    def _get_port_text(self, ctx: DOTParser.PortContext) -> str:
