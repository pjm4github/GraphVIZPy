...
class DOTParser ( Parser ):
    ...
    class GraphContext(ParserRuleContext):
        ...
        def graphType(self):
            return self.getTypedRuleContext(DOTParser.GraphTypeContext,0)


        def LBRACE(self):
            return self.getToken(DOTParser.LBRACE, 0)

        def stmtList(self):
            return self.getTypedRuleContext(DOTParser.StmtListContext,0)


        def RBRACE(self):
            return self.getToken(DOTParser.RBRACE, 0)

        def EOF(self):
            return self.getToken(DOTParser.EOF, 0)

        def KW_STRICT(self):
            return self.getToken(DOTParser.KW_STRICT, 0)
    ...
    def graph(self):
        ...
        try:
            ...
            if _la==1:
                self.state = 34
                self.match(DOTParser.KW_STRICT)
            ...
            self.state = 41
            self.match(DOTParser.LBRACE)
            self.state = 42
            self.stmtList()
            self.state = 43
            self.match(DOTParser.RBRACE)
            self.state = 44
    ...
    class GraphTypeContext(ParserRuleContext):
        ...
        def KW_GRAPH(self):
            return self.getToken(DOTParser.KW_GRAPH, 0)

        def KW_DIGRAPH(self):
            return self.getToken(DOTParser.KW_DIGRAPH, 0)

        def getRuleIndex(self):
            return DOTParser.RULE_graphType
    ...
    def graphType(self):
        ...
        localctx = DOTParser.GraphTypeContext(self, self._ctx, self.state)
    ...
    class StmtListContext(ParserRuleContext):
        ...
        def SEMI(self, i:int=None):
            if i is None:
                return self.getTokens(DOTParser.SEMI)
            else:
                return self.getToken(DOTParser.SEMI, i)

        def getRuleIndex(self):
            return DOTParser.RULE_stmtList
    ...
    def stmtList(self):
        ...
        localctx = DOTParser.StmtListContext(self, self._ctx, self.state)
    ...
    class StmtContext(ParserRuleContext):
        ...
        def attrStmt(self):
            return self.getTypedRuleContext(DOTParser.AttrStmtContext,0)


        def edgeStmt(self):
            return self.getTypedRuleContext(DOTParser.EdgeStmtContext,0)


        def nodeStmt(self):
            return self.getTypedRuleContext(DOTParser.NodeStmtContext,0)
        ...
        def EQUALS(self):
            return self.getToken(DOTParser.EQUALS, 0)
    ...
    class AttrStmtContext(ParserRuleContext):
        ...
        def attrList(self):
            return self.getTypedRuleContext(DOTParser.AttrListContext,0)
        ...
        def KW_NODE(self):
            return self.getToken(DOTParser.KW_NODE, 0)

        def KW_EDGE(self):
            return self.getToken(DOTParser.KW_EDGE, 0)

        def getRuleIndex(self):
            return DOTParser.RULE_attrStmt
    ...
    def attrStmt(self):
        ...
        localctx = DOTParser.AttrStmtContext(self, self._ctx, self.state)
    ...
    class AttrListContext(ParserRuleContext):
        ...
        def LBRACK(self, i:int=None):
            if i is None:
                return self.getTokens(DOTParser.LBRACK)
            else:
                return self.getToken(DOTParser.LBRACK, i)

        def RBRACK(self, i:int=None):
            if i is None:
                return self.getTokens(DOTParser.RBRACK)
            else:
                return self.getToken(DOTParser.RBRACK, i)

        def aList(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(DOTParser.AListContext)
            else:
                return self.getTypedRuleContext(DOTParser.AListContext,i)


        def getRuleIndex(self):
            return DOTParser.RULE_attrList
    ...
    def attrList(self):
        ...
        localctx = DOTParser.AttrListContext(self, self._ctx, self.state)
    ...
    class AListContext(ParserRuleContext):
        ...
        def EQUALS(self, i:int=None):
            if i is None:
                return self.getTokens(DOTParser.EQUALS)
            else:
                return self.getToken(DOTParser.EQUALS, i)
        ...
        def COMMA(self, i:int=None):
            if i is None:
                return self.getTokens(DOTParser.COMMA)
            else:
                return self.getToken(DOTParser.COMMA, i)

        def getRuleIndex(self):
            return DOTParser.RULE_aList
    ...
    def aList(self):
        ...
        localctx = DOTParser.AListContext(self, self._ctx, self.state)
    ...
    class EdgeStmtContext(ParserRuleContext):
        ...
        def nodeId(self):
            return self.getTypedRuleContext(DOTParser.NodeIdContext,0)
        ...
        def edgeRhs(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(DOTParser.EdgeRhsContext)
            else:
                return self.getTypedRuleContext(DOTParser.EdgeRhsContext,i)
        ...
        def getRuleIndex(self):
            return DOTParser.RULE_edgeStmt
    ...
    def edgeStmt(self):
        ...
        localctx = DOTParser.EdgeStmtContext(self, self._ctx, self.state)
    ...
    class EdgeRhsContext(ParserRuleContext):
        ...
        def edgeOp(self):
            return self.getTypedRuleContext(DOTParser.EdgeOpContext,0)
    ...
    class EdgeOpContext(ParserRuleContext):
        ...
        def DIRECTED_EDGE(self):
            return self.getToken(DOTParser.DIRECTED_EDGE, 0)

        def UNDIRECTED_EDGE(self):
            return self.getToken(DOTParser.UNDIRECTED_EDGE, 0)
    ...
    class NodeStmtContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return DOTParser.RULE_nodeStmt
    ...
    def nodeStmt(self):
        ...
        localctx = DOTParser.NodeStmtContext(self, self._ctx, self.state)
    ...
    def nodeId(self):
        ...
        localctx = DOTParser.NodeIdContext(self, self._ctx, self.state)
    ...
    class SubgraphContext(ParserRuleContext):
        ...
        def KW_SUBGRAPH(self):
            return self.getToken(DOTParser.KW_SUBGRAPH, 0)
    ...
    def subgraph(self):
        ...
        try:
            ...
            if _la==6:
                self.state = 122
                self.match(DOTParser.KW_SUBGRAPH)
                self.state = 124
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & 17694720) != 0):
    ...
    class Id_Context(ParserRuleContext):
        ...
        def QUOTED_STRING(self):
            return self.getToken(DOTParser.QUOTED_STRING, 0)

        def htmlString(self):
            return self.getTypedRuleContext(DOTParser.HtmlStringContext,0)
    ...
    def id_(self):
        ...
        try:
            ...
            if token in [19]:
                ...
                self.enterOuterAlt(localctx, 3)
                self.state = 134
                self.match(DOTParser.QUOTED_STRING)
                pass
            elif token in [24]:
                self.enterOuterAlt(localctx, 4)
                self.state = 135
    ...
    class HtmlStringContext(ParserRuleContext):
        ...
        def HTML_OPEN(self):
            return self.getToken(DOTParser.HTML_OPEN, 0)

        def HTML_CLOSE(self):
            return self.getToken(DOTParser.HTML_CLOSE, 0)

        def htmlContent(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(DOTParser.HtmlContentContext)
            else:
                return self.getTypedRuleContext(DOTParser.HtmlContentContext,i)


        def getRuleIndex(self):
            return DOTParser.RULE_htmlString
    ...
    def htmlString(self):
        ...
        localctx = DOTParser.HtmlStringContext(self, self._ctx, self.state)
        self.enterRule(localctx, 30, self.RULE_htmlString)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 138
            self.match(DOTParser.HTML_OPEN)
            self.state = 142
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            ...
            self.state = 145
            self.match(DOTParser.HTML_CLOSE)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class HtmlContentContext(ParserRuleContext):
        ...
        def HTML_TEXT(self):
            return self.getToken(DOTParser.HTML_TEXT, 0)
        ...
        def getRuleIndex(self):
            return DOTParser.RULE_htmlContent
    ...
    def htmlContent(self):
        ...
        localctx = DOTParser.HtmlContentContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [26]:
                self.enterOuterAlt(localctx, 1)
                self.state = 147
                self.match(DOTParser.HTML_TEXT)
                pass
            elif token in [24]:
                self.enterOuterAlt(localctx, 2)
                self.state = 148
