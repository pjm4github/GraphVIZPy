...
class TestAgraphMethods3:
    ...
    def test_aginitcb_resets_callbacks(self):
        ...
        assert extra_node_added_callback in self.graph.clos.callbacks['node_added']
    ...
    def test_aghide_successful(self):
        """Test successful hiding with custom disciplines, renamed nodes, and edge reconnection."""
        # Expose subgraph
