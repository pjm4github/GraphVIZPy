...
- Graphs audited: **197** (175 ok, 22 errored/timeout)
- Graphs clean on both sides (0 crossings): **163**
- Python regression cases (py > c): **12**
- Total Python crossings: **166**
- Total C crossings: **0**
- Net delta (py − c): **+166**
...
| 1332_ref.dot | ok | 91 | 111 | 4 | 0 | 0 | +4 |
